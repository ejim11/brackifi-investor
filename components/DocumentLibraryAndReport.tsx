        ...
        >
          {reports.map((report: any, i: number) => (
            <motion.div
              variants={item}
              key={i}
              className="w-full flex sm:flex-col p-[1.5rem] mb-[1.5rem] last:mb-0 items-center  bg-color-black-light-2 rounded-lg "
            >
              <div className="w-[10rem] h-[10rem] sm:w-full sm:h-[15rem]  rounded-md">
                <Image
              ...
              <div className="mx-[1rem] flex-1 sm:mx-0 sm:my-[1.5rem]">
                <p className="text-color-primary-1 text-[1.7rem] font-semibold capitalize">
                  {report.title}
                </p>
                <p className="text-color-secondary-2">{report.summary}</p>
              ...
              <a
                ...
                download={true}
                target="blank"
                className="w-auto sm:w-full sm:text-center bg-color-primary-1 text-color-white py-[0.5rem] px-[1rem] rounded-md border border-color-primary-1 hover:text-color-primary-1 hover:bg-color-transparent font-semibold transition-all duration-100 ease-in "
              >
                View
              </a>
            </motion.div>
